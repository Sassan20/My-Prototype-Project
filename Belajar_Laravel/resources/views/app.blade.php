...
<html lang="en">
  ...
  <body>
  <nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#ffd700; opacity: 0.5;">
  ...
  <div class="container">
    ...
    <div class="row justify-content-center fs-5 text-center">
      <div class="col-md-4 mb-3">
        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Reiciendis, nesciunt earum? Tenetur hic doloribus reprehenderit maiores aut pariatur perferendis quaerat.</p>
      </div>
      <div class="col-md-4 mb-3">
        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Reiciendis, nesciunt earum? Tenetur hic doloribus reprehenderit maiores aut pariatur perferendis quaerat.</p>
      </div>
      ...
      <div class="row justify-content-center">
        <div class="col-md-4 mb-3">
          <div class="card">
            ...
            <div class="card-cody">
              <p class="card-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Consectetur recusandae molestias voluptate adipisci blanditiis. Enim nobis accusamus quia cumque accusantium.</p>
            </div>
          </div>
        </div>
      </div>
